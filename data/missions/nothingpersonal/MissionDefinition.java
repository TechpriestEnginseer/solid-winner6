...
//		api.addBriefingItem("Ships ordered to retreat will escape along the top edge of the map");
		...
		member2.setCaptain(OfficerManagerEvent.createOfficer(Global.getSector().getFaction(Factions.INDEPENDENT), 2, FleetFactoryV3.getSkillPrefForShip(member2), true, null, true, true, 1, new Random()));
        ...
        member5.setCaptain(OfficerManagerEvent.createOfficer(Global.getSector().getFaction(Factions.INDEPENDENT), 2, FleetFactoryV3.getSkillPrefForShip(member5), true, null, true, true, 1, new Random()));
		...
		*/
		...
		member6.setCaptain(OfficerManagerEvent.createOfficer(Global.getSector().getFaction(Factions.HEGEMONY), 1, FleetFactoryV3.getSkillPrefForShip(member6), true, null, true, false, 0, new Random()));
		...
		member7.setCaptain(OfficerManagerEvent.createOfficer(Global.getSector().getFaction(Factions.HEGEMONY), 1, FleetFactoryV3.getSkillPrefForShip(member7), true, null, true, false, 0, new Random()));
//		api.addToFleet(FleetSide.ENEMY, "enforcer_Balanced", FleetMemberType.SHIP, false);
		...
		member8.setCaptain(OfficerManagerEvent.createOfficer(Global.getSector().getFaction(Factions.HEGEMONY), 1, FleetFactoryV3.getSkillPrefForShip(member8), true, null, true, false, 0, new Random()));
